...
#cargamos imagen
image1 = cv2.imread('static\goku.jpg')
...
image3 = cv2.imread('static\harry.jpg')
...
image4 = cv2.imread('static\sailor.jpg')
...
image5 = cv2.imread('static\ranma.jpg')
...
image6 = cv2.imread('static\pokemon.jpg')
...
image7 = cv2.imread('static\supercampeones.jpg')
...
image8 = cv2.imread('bainia.jpg', cv2.IMREAD_GRAYSCALE)
